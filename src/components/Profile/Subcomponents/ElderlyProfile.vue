    ...
    <div class="flex items-center justify-center">
      <div class="n-1/3 mt-10 rounded-lg">
        <div class="flex items-center justify-center flex-col">
          ...
          <h2 class="text-gray-200 font-semibold mt-3"> Adres zamieszkania: </h2> <p class="text-slate-200"> {{ userObject.address }} </p>
          ...
          <h2 class="text-gray-200 font-semibold mt-3"> Nr awaryjny: </h2> <p class="text-slate-200"> {{ userObject.emergency_number }} </p>
          <h2 class="text-gray-200 font-semibold mt-3"> Wzrost: </h2> <p class="text-slate-200"> {{ userObject.height }} </p>
          <h2 class="text-gray-200 font-semibold mt-3"> Waga: </h2> <p class="text-slate-200"> {{ userObject.weight }} </p>
